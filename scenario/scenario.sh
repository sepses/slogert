...
start=$SECONDS
java -Xmx4g -jar exe/lutra.jar --library scenario/output/apache-error-log_templates.ottr --libraryFormat stottr --inputFormat stottr scenario/output/apache-error.log_structured.ottr --mode expand --fetchMissing > scenario/output-ttl/apache-error.log_structured.ttl
duration=$(( SECONDS - start ))
getDuration "apache-error" $duration

start=$SECONDS
java -Xmx4g -jar exe/lutra.jar --library scenario/output/apache-host-log_templates.ottr --libraryFormat stottr --inputFormat stottr scenario/output/apache-host.log_structured.ottr --mode expand --fetchMissing > scenario/output-ttl/apache-host.log_structured.ttl
duration=$(( SECONDS - start ))
getDuration "apache-host" $duration

start=$SECONDS
java -Xmx4g -jar exe/lutra.jar --library scenario/output/apache-access-log_templates.ottr --libraryFormat stottr --inputFormat stottr scenario/output/apache-access.log_structured.ottr --mode expand --fetchMissing > scenario/output-ttl/apache-access.log_structured.ttl
duration=$(( SECONDS - start ))
