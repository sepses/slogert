...
input_dir  = 'output/mail.log/1-init' # The input directory of log file
output_dir = 'output/mail.log/2-logpai' # The output directory of parsing results
log_file   = 'mail.log.0' # The input log file name
